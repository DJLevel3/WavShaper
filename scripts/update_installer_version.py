...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=WavShaper Demo Installer\n"
      else:
        line="OutputBaseFilename=WavShaper Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the WavShaper Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the WavShaper installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=WavShaper Demo installer\n"
     else:
       line="SetupWindowTitle=WavShaper installer\n"
